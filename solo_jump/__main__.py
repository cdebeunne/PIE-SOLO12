...
kwargs_trajec = {"traj_dx0":0*0.05, "traj_t0":1, "traj_t1":1, "traj_t2":0.5, "traj_z0":-0.25, "traj_dz":-0.20, "traj_zf":-0.22, "kps":[1.5, 1.6], "kds":[0.05, 0.06]}
...
# Save the trajectory
traj.saveTrajectory('traj_1.npz')
