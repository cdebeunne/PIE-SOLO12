...
# Parameters for 
kwargs_trajec = {"traj_dx0":0.1, "traj_t0":0.25, "traj_t1":0.25, "traj_z0":-0.05, "traj_zf":-0.2, "kps":[10, 5], "kds":[0.1, 2]}
kwargs_kininv = {"init_reversed":False, "tf":1.5, "dt":0.01, "debug":True}
